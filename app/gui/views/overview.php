	...
	<form action="" method="post" class="keyform">
		<div class="inputvalues">
			<header class="add-key-section collapsible">
				...
				<div class="trans-item collapsible-content">
					...
					<div class="add-key-actions">
						<input type="submit" value="Add Key" class="add-key-btn">
					</div>
				</div>
			</header>
			...
			<div class="form-actions">
				<input type="submit" value="Save Changes (CMD + S)" class="save-changes-btn">
				<button type="button" id="multiDeleteModeBtn">Bulk Delete</button>
				<button class="btn--error" type="button" id="deleteSelectedBtn" style="display:none">
